...
abstract class Token implements ActiveRecordInterface
{
     ...
     *
     * Note: this column has a database default value of: 'access'
     * @var        string
     */
    protected $type;
    ...
    /**
     * The value for the expire_dt field.
     *
     * @var        DateTime
     */
    protected $expire_dt;
    ...
    /**
     * Initializes internal state of Leftaro\App\Model\Base\Token object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [optionally formatted] temporal [expire_dt] column value.
     *
     *
     ...
     */
    public function getExpireDt($format = NULL)
    {
        if ($format === null) {
            return $this->expire_dt;
        } else {
            return $this->expire_dt instanceof \DateTimeInterface ? $this->expire_dt->format($format) : null;
        }
    }
     ...
     * @return $this|\Leftaro\App\Model\Token The current object (for fluent API support)
     */
    ...
    public function setDetails($v)
    {
        ...
        if ($this->details !== $v) {
            $this->details = $v;
            $this->modifiedColumns[TokenTableMap::COL_DETAILS] = true;
        }
    ...
    /**
     * Sets the value of [expire_dt] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Leftaro\App\Model\Token The current object (for fluent API support)
     */
    public function setExpireDt($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->expire_dt !== null || $dt !== null) {
            if ($this->expire_dt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->expire_dt->format("Y-m-d H:i:s.u")) {
                $this->expire_dt = $dt === null ? null : clone $dt;
                $this->modifiedColumns[TokenTableMap::COL_EXPIRE_DT] = true;
            }
    ...
    public function setCreatedDt($v)
    {
        ...
        if ($this->created_dt !== null || $dt !== null) {
            if ($this->created_dt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_dt->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TokenTableMap::COL_CREATED_DT] = true;
            }
        } // if either are not null
    ...
    public function setUpdatedDt($v)
    {
        ...
        if ($this->updated_dt !== null || $dt !== null) {
            if ($this->updated_dt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_dt->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[TokenTableMap::COL_UPDATED_DT] = true;
            }
        } // if either are not null
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[TokenTableMap::COL_USER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TokenTableMap::translateFieldName('Details', TableMap::TYPE_PHPNAME, $indexType)];
            $this->details = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TokenTableMap::translateFieldName('ExpireDt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->expire_dt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TokenTableMap::translateFieldName('CreatedDt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_dt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TokenTableMap::translateFieldName('UpdatedDt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_dt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : TokenTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TokenTableMap::COL_DETAILS)) {
            $modifiedColumns[':p' . $index++]  = 'details';
        }
        if ($this->isColumnModified(TokenTableMap::COL_EXPIRE_DT)) {
            $modifiedColumns[':p' . $index++]  = 'expire_dt';
        }
        if ($this->isColumnModified(TokenTableMap::COL_CREATED_DT)) {
            $modifiedColumns[':p' . $index++]  = 'created_dt';
        }
        if ($this->isColumnModified(TokenTableMap::COL_UPDATED_DT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_dt';
        }
        if ($this->isColumnModified(TokenTableMap::COL_USER_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'details':
                        ...
                        break;
                    case 'expire_dt':
                        $stmt->bindValue($identifier, $this->expire_dt ? $this->expire_dt->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'created_dt':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getExpireDt(),
            $keys[4] => $this->getCreatedDt(),
            $keys[5] => $this->getUpdatedDt(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Leftaro\App\Model\Token
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setDetails($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setExpireDt($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setCreatedDt($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setUpdatedDt($arr[$keys[5]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Leftaro\App\Model\Token The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TokenTableMap::COL_DETAILS)) {
            $criteria->add(TokenTableMap::COL_DETAILS, $this->details);
        }
        if ($this->isColumnModified(TokenTableMap::COL_EXPIRE_DT)) {
            $criteria->add(TokenTableMap::COL_EXPIRE_DT, $this->expire_dt);
        }
        if ($this->isColumnModified(TokenTableMap::COL_CREATED_DT)) {
            $criteria->add(TokenTableMap::COL_CREATED_DT, $this->created_dt);
        }
        if ($this->isColumnModified(TokenTableMap::COL_UPDATED_DT)) {
            $criteria->add(TokenTableMap::COL_UPDATED_DT, $this->updated_dt);
        }
        if ($this->isColumnModified(TokenTableMap::COL_USER_ID)) {
            $criteria->add(TokenTableMap::COL_USER_ID, $this->user_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Leftaro\App\Model\Token (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setExpireDt($this->getExpireDt());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Leftaro\App\Model\Token Clone of current object.
     * @throws PropelException
     */
