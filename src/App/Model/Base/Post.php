...
abstract class Post implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Leftaro\\App\\Model\\Leftaro\\App\\Model\\Map\\PostTableMap';
    ...
    /**
     * The value for the published_dt field.
     *
     * @var        DateTime
     */
    protected $published_dt;
    ...
    /**
     * The value for the deleted_dt field.
     *
     * @var        DateTime
     */
    ...
    /**
     * Initializes internal state of Leftaro\App\Model\Base\Post object.
     */
    ...
    /**
     * Get the [optionally formatted] temporal [published_dt] column value.
     *
     *
     ...
     */
    public function getPublishedDt($format = NULL)
    {
        if ($format === null) {
            return $this->published_dt;
        } else {
            return $this->published_dt instanceof \DateTimeInterface ? $this->published_dt->format($format) : null;
        }
    }
    ...
    /**
     * Get the [optionally formatted] temporal [deleted_dt] column value.
     *
     *
     * @param      string $format The date/time format string (either date()-style or strftime()-style).
     *                            If format is NULL, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getDeletedDt($format = NULL)
    {
        if ($format === null) {
            return $this->deleted_dt;
        } else {
            return $this->deleted_dt instanceof \DateTimeInterface ? $this->deleted_dt->format($format) : null;
        }
    }
    ...
    /**
     * Sets the value of [published_dt] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Leftaro\App\Model\Post The current object (for fluent API support)
     */
    public function setPublishedDt($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->published_dt !== null || $dt !== null) {
            if ($this->published_dt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->published_dt->format("Y-m-d H:i:s.u")) {
                $this->published_dt = $dt === null ? null : clone $dt;
                $this->modifiedColumns[PostTableMap::COL_PUBLISHED_DT] = true;
            }
    ...
    public function setCreatedDt($v)
    {
        ...
        if ($this->created_dt !== null || $dt !== null) {
            if ($this->created_dt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_dt->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PostTableMap::COL_CREATED_DT] = true;
            }
        } // if either are not null
    ...
    public function setUpdatedDt($v)
    {
        ...
        if ($this->updated_dt !== null || $dt !== null) {
            if ($this->updated_dt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_dt->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[PostTableMap::COL_UPDATED_DT] = true;
            }
        } // if either are not null
    ...
    /**
     * Sets the value of [deleted_dt] column to a normalized version of the date/time value specified.
     *
     * @param  mixed $v string, integer (timestamp), or \DateTimeInterface value.
     *               Empty strings are treated as NULL.
     * @return $this|\Leftaro\App\Model\Post The current object (for fluent API support)
     */
    public function setDeletedDt($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->deleted_dt !== null || $dt !== null) {
            if ($this->deleted_dt === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->deleted_dt->format("Y-m-d H:i:s.u")) {
                $this->deleted_dt = $dt === null ? null : clone $dt;
                $this->modifiedColumns[PostTableMap::COL_DELETED_DT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PostTableMap::translateFieldName('Slug', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : PostTableMap::translateFieldName('PublishedDt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->published_dt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : PostTableMap::translateFieldName('CreatedDt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_dt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : PostTableMap::translateFieldName('UpdatedDt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated_dt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : PostTableMap::translateFieldName('DeletedDt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->deleted_dt = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Leftaro\\App\\Model\\Leftaro\\App\\Model\\Post'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PostTableMap::COL_PUBLISHED_DT)) {
            $modifiedColumns[':p' . $index++]  = 'published_dt';
        }
        if ($this->isColumnModified(PostTableMap::COL_CREATED_DT)) {
            $modifiedColumns[':p' . $index++]  = 'created_dt';
        }
        if ($this->isColumnModified(PostTableMap::COL_UPDATED_DT)) {
            $modifiedColumns[':p' . $index++]  = 'updated_dt';
        }
        if ($this->isColumnModified(PostTableMap::COL_DELETED_DT)) {
            $modifiedColumns[':p' . $index++]  = 'deleted_dt';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'description':
                        ...
                        break;
                    case 'published_dt':
                        $stmt->bindValue($identifier, $this->published_dt ? $this->published_dt->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'created_dt':
                    ...
                    case 'updated_dt':
                        ...
                        break;
                    case 'deleted_dt':
                        $stmt->bindValue($identifier, $this->deleted_dt ? $this->deleted_dt->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'user_id':
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Leftaro\App\Model\Post
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) {
            $this->setPublishedDt($arr[$keys[4]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Leftaro\App\Model\Post The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PostTableMap::COL_PUBLISHED_DT)) {
            $criteria->add(PostTableMap::COL_PUBLISHED_DT, $this->published_dt);
        }
        if ($this->isColumnModified(PostTableMap::COL_CREATED_DT)) {
            $criteria->add(PostTableMap::COL_CREATED_DT, $this->created_dt);
        }
        if ($this->isColumnModified(PostTableMap::COL_UPDATED_DT)) {
            $criteria->add(PostTableMap::COL_UPDATED_DT, $this->updated_dt);
        }
        if ($this->isColumnModified(PostTableMap::COL_DELETED_DT)) {
            $criteria->add(PostTableMap::COL_DELETED_DT, $this->deleted_dt);
        }
        if ($this->isColumnModified(PostTableMap::COL_USER_ID)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Leftaro\App\Model\Post (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setPublishedDt($this->getPublishedDt());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Leftaro\App\Model\Post Clone of current object.
     * @throws PropelException
     */
