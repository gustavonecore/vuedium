...
class TokenTableMap extends TableMap
{
     ...
     */
    const COL_DETAILS = 'token.details';

    /**
     * the column name for the expire_dt field
     */
    const COL_EXPIRE_DT = 'token.expire_dt';

    /**
     * the column name for the created_dt field
     */
    const COL_CREATED_DT = 'token.created_dt';

    /**
     * the column name for the updated_dt field
     */
    const COL_UPDATED_DT = 'token.updated_dt';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'token.user_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Type', 'Details', 'ExpireDt', 'CreatedDt', 'UpdatedDt', 'UserId', ),
        self::TYPE_CAMELNAME     => array('id', 'type', 'details', 'expireDt', 'createdDt', 'updatedDt', 'userId', ),
        self::TYPE_COLNAME       => array(TokenTableMap::COL_ID, TokenTableMap::COL_TYPE, TokenTableMap::COL_DETAILS, TokenTableMap::COL_EXPIRE_DT, TokenTableMap::COL_CREATED_DT, TokenTableMap::COL_UPDATED_DT, TokenTableMap::COL_USER_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'type', 'details', 'expire_dt', 'created_dt', 'updated_dt', 'user_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Type' => 1, 'Details' => 2, 'ExpireDt' => 3, 'CreatedDt' => 4, 'UpdatedDt' => 5, 'UserId' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'type' => 1, 'details' => 2, 'expireDt' => 3, 'createdDt' => 4, 'updatedDt' => 5, 'userId' => 6, ),
        self::TYPE_COLNAME       => array(TokenTableMap::COL_ID => 0, TokenTableMap::COL_TYPE => 1, TokenTableMap::COL_DETAILS => 2, TokenTableMap::COL_EXPIRE_DT => 3, TokenTableMap::COL_CREATED_DT => 4, TokenTableMap::COL_UPDATED_DT => 5, TokenTableMap::COL_USER_ID => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'type' => 1, 'details' => 2, 'expire_dt' => 3, 'created_dt' => 4, 'updated_dt' => 5, 'user_id' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('type', 'Type', 'VARCHAR', true, 10, 'access');
        $this->addColumn('details', 'Details', 'LONGVARCHAR', false, null, null);
        $this->addColumn('expire_dt', 'ExpireDt', 'TIMESTAMP', true, null, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TokenTableMap::COL_DETAILS);
            $criteria->addSelectColumn(TokenTableMap::COL_EXPIRE_DT);
            $criteria->addSelectColumn(TokenTableMap::COL_CREATED_DT);
            $criteria->addSelectColumn(TokenTableMap::COL_UPDATED_DT);
            $criteria->addSelectColumn(TokenTableMap::COL_USER_ID);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.type');
            $criteria->addSelectColumn($alias . '.details');
            $criteria->addSelectColumn($alias . '.expire_dt');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Leftaro\App\Model\Token) { // it's a model object
