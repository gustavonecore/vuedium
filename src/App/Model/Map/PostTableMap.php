...
class PostTableMap extends TableMap
{
    ...
    /**
     * the column name for the published_dt field
     */
    const COL_PUBLISHED_DT = 'post.published_dt';
    ...
    /**
     * the column name for the deleted_dt field
     */
    const COL_DELETED_DT = 'post.deleted_dt';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('slug', 'Slug', 'VARCHAR', true, 500, null);
        $this->addColumn('title', 'Title', 'VARCHAR', true, 255, null);
        $this->addColumn('description', 'Description', 'LONGVARCHAR', true, null, null);
        $this->addColumn('published_dt', 'PublishedDt', 'TIMESTAMP', false, null, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PostTableMap::COL_SLUG);
            $criteria->addSelectColumn(PostTableMap::COL_TITLE);
            $criteria->addSelectColumn(PostTableMap::COL_DESCRIPTION);
            $criteria->addSelectColumn(PostTableMap::COL_PUBLISHED_DT);
            ...
            $criteria->addSelectColumn($alias . '.published_dt');
